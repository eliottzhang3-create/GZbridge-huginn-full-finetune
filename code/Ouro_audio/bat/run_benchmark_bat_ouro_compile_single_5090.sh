...
OUTPUT_REPORT="${BAT_COMPILE_OUTPUT_REPORT:-/hpc_stor03/sjtu_home/jinwei.zhang/outputs/ouro/bat/compile_single_5090-$(date +%Y%m%d-%H%M%S).json}"
STEPS="${BAT_COMPILE_STEPS:-10}"
WARMUP_STEPS="${BAT_COMPILE_WARMUP_STEPS:-3}"
LOCAL_BATCH_SIZE="${BAT_COMPILE_LOCAL_BATCH_SIZE:-8}"
