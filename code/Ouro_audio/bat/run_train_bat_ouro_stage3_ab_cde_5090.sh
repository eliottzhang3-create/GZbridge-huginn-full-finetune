...
for name in OURO_MODEL_PATH OURO_BAT_PLUGIN_PATH BAT_LOCAL_CACHE_ROOT BAT_RUNTIME_MONITOR_INTERVAL_STEPS BAT_ARROW_PREWARM_REPORT BAT_MAX_STEPS_OVERRIDE MASTER_PORT; do
  value="${!name:-}"
  if [ -n "$value" ]; then
