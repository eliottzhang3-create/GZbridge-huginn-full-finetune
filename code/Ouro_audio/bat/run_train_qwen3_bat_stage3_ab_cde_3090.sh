...
for name in QWEN3_MODEL_PATH QWEN3_BAT_PLUGIN_PATH QWEN3_BAT_STAGE3_AB_CDE_RESUME_FROM_CHECKPOINT BAT_LOCAL_CACHE_ROOT BAT_RUNTIME_MONITOR_INTERVAL_STEPS BAT_ARROW_PREWARM_REPORT MASTER_PORT; do
  value="${!name:-}"
  if [ -n "$value" ]; then
