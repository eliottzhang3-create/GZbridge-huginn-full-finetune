...
: "${QWEN3_BAT_DDP_RESUME_SOURCE_MANIFEST:?Set QWEN3_BAT_DDP_RESUME_SOURCE_MANIFEST before submitting}"
...
CMD_PREFIX="QWEN3_BAT_DDP_RESUME_SOURCE_MANIFEST=$(printf '%q' "$SOURCE_MANIFEST") QWEN3_BAT_DDP_RESUME_ROOT=$(printf '%q' "$ROOT_DIR") "
