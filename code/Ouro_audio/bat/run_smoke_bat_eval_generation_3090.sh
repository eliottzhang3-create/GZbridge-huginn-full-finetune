...
for name in BAT_EVAL_MODEL_PATH BAT_EVAL_PLUGIN_PATH BAT_EVAL_CHECKPOINT BAT_EVAL_QA_ROOT BAT_EVAL_AUDIO_ROOT BAT_EVAL_REVERB_ROOT BAT_EVAL_SPATIAL_AST_ROOT BAT_EVAL_SPATIAL_AST_CHECKPOINT BAT_EVAL_QFORMER_SOURCE BAT_EVAL_MAX_RECORDS_PER_SPLIT BAT_EVAL_REPEAT BAT_EVAL_MAX_NEW_TOKENS BAT_EVAL_NUM_BEAMS BAT_EVAL_RIR_POLICY BAT_EVAL_INCLUDE_NONBINARY; do
  append_env "$name"
done
