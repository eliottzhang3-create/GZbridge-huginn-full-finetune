...
OUTPUT_ROOT="${HUGINN_DYNAMIC90S_FULL_POOL_ROOT:-$REPO_ROOT/data/audio_swift/huginn_whisper_dynamic90s_multitask/v1}"
...
echo "========== PREPARE HUGINN WHISPER DYNAMIC90S FULL ATOMIC POOLS =========="
...
echo "========== PREPARE HUGINN WHISPER DYNAMIC90S FULL ATOMIC POOLS EXIT =========="
