...
CMD_PREFIX=""
for name in CLOTHO_CAPTION_CHECKPOINT CLOTHO_CAPTION_CHECKPOINTS CLOTHO_CAPTION_OUTPUT_DIR CLOTHO_CAPTION_SAMPLE_COUNT CLOTHO_CAPTION_MAX_NEW_TOKENS; do
  value="${!name:-}"
  if [ -n "$value" ]; then
