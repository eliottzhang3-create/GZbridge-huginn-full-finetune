...
vc submit \
  ...
  -c 8 -m 32G -g 1 \
  -n 1 \
  -j inspect-whisper-dyn30-checkpoint25000-5090-$(date +%m%d%H%M) \
  -d "$SCRIPT_DIR" \
  JOB=1:1 "$SCRIPT_DIR/log/inspect_huginn_whisper_dynamic30s_multiplier_checkpoint_25000_5090.JOB.log" \
