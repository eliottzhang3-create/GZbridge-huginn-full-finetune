...
OUTPUT_DIR="outputs/huginn_whisper_dynamic30s_multiplier_checkpoint46050_clotho_retrieval"
...
vc submit \
  ...
  -c 8 -m 32G -g 1 \
  -n 1 \
  -j eval-whisper-dynamic30s-multiplier-46050-4090-$(date +%m%d%H%M) \
  -d "$SCRIPT_DIR" \
  JOB=1:1 "$SCRIPT_DIR/log/eval_huginn_audio_whisper_dynamic30s_multiplier_checkpoint46050_4090.JOB.log" \
