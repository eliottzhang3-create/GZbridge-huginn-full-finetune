...
CHECKPOINT_ROOT=/hpc_stor03/sjtu_home/jinwei.zhang/code/GZbridge-huginn-full-finetune/outputs/huginn_losatok_dynamic90s_audiocaps_v2_e2_b4ga4_fsdp2_complete/v0-20260724-115115
...
OUTPUT_DIR="outputs/huginn_losatok_dynamic90s_audiocaps_v2_e2_fsdp2_complete_clotho_caption_samples"
...
vc submit \
  ...
  -c 8 -m 32G -g 1 \
  -n 1 \
  -j generate-losatok-dynamic90s-e2-clotho-5090-$(date +%m%d%H%M) \
  -d "$SCRIPT_DIR" \
